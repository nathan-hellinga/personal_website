          ...
          <Row>
            <Col>
              <ul>
                ...
                <ul>
                  <li>
                    WEB: React, Express, Flask, Redux, Next.js, Material UI
                  </li>
                  <li>
          ...
          <Row>
            <Col>
              <div className={'resumeItem'}>
                ...
                <ul>
                  <li>
                    Created new business streams by training and evaluating a machine learning model to detect Ontario
                    road signs from dashcam footage
                  </li>
                  <li>
              ...
              <div className={'resumeItem'}>
                ...
                <ul>
                  ...
                  <li>
                    Worked as a core developer on a project to build an internal Learning and Development platform using
                    Agile software practises
                  </li>
                </ul>
              </div>
